...
if (isset($_POST['submit'])) {
  extract($_POST);
  $cql = "Insert into one(firstname,lastname,email,contact,country,state,city,address,username,password)
values('$firstname','$lastname','$email','$contact','$country','$state','$city','$address','$username','$password')";

  if ($conn->query($cql) === TRUE) {
    echo "New record created successfully";
  } else {
    echo "Error: " . $cql . "<br>" . $conn->error;
  }
  $conn->close();
...
<body>
  <div class="login-page">
          ...
          <div class="row gx-0 align-items-stretch">
            ...
            <div class="col-lg-6">
              <div class="info d-flex justify-content-center flex-column p-4 h-100">
                <div class="py-5">
                  <h1 class="display-6 fw-bold">REGISTRATION FORM</h1>
                  <p class="fw-light mb-0">Student Registration Form</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                <form class="w-100" method="POST" action="">
                  <div class="input-material-group mb-3 mt-3">
                    <input class="input-material" type="text" name="firstname" required>
                    <label class="label-material" for="register-username">First Name </label>
                  </div>
                  <div class="input-material-group mb-3 mt-3">
                    <input class="input-material" type="text" name="lastname" required>
                    <label class="label-material" for="register-username">Last Name </label>
                  </div>
                  ...
                  <div class="input-material-group mb-4">
                    <input class="input-material" type="text" name="contact" required>
                    <label class="label-material">Contact</label>
                  </div>
                  <div class="row">
                  ...
                  <div class="input-material-group mb-4">
                    <input class="input-material" type="text" name="country" required>
                    <label class="label-material">Country</label>
                  </div>
                  <div class="input-material-group mb-4">
                    <input class="input-material" type="text" name="state" required>
                    <label class="label-material">State</label>
                  </div>
                  <div class="input-material-group mb-4">
                    <input class="input-material" type="text" name="city" required>
                    <label class="label-material">City</label>
                  </div>
                  <div class="input-material-group mb-4">
                    <input class="input-material" type="text" name="address" required>
                  ...
                  <a class="text-sm text-paleBlue mb-3" href="login.php">Login</a>
                </form>
              </div>
            </div>
          </div>
    ...
    <div class="text-center position-absolute bottom-0 start-0 w-100 z-index-20">
      <p class="text-white">Design by <a class="external" href="https://bootstrapious.com/p/admin-template">Ganesh
          Kekan</a>
