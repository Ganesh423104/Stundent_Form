...
if (!isset($_SESSION['username'])) {
  if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM one WHERE (username='$username' AND password ='$password')";
          ...
          <div class="row gx-0 align-items-stretch">
            ...
            <div class="col-lg-6">
              <div class="info d-flex justify-content-center flex-column p-4 h-100">
                <div class="py-5">
                  <h1 class="display-6 fw-bold">LOGIN FORM</h1>
                  <p class="fw-light mb-0">Student Login Form</p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
              ...
              <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                <form class="w-100" method="post" action="">
                  <div class="input-material-group mb-3">
                    <input class="input-material" id="login-username" type="text" name="username" autocomplete=""
                      required data-validate-field="loginUsername">
                  ...
                  <div class="text-start">
                    <button type="submit" class="btn bg-primary text-white my-4 mb-2" name="login">Login</button>
                  </div><br>
                  <a class="text-sm text-paleBlue" href="#">Forgot Password?</a><br>
                  <small class="text-gray-500">Do not have an account? </small>
                  <a class="text-sm text-paleBlue" href="register.php">Registration</a>
                </form>
              </div>
            </div>
          </div>
